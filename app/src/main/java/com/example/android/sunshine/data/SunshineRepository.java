...
public class SunshineRepository {
    ...
    private SunshineRepository(WeatherDao weatherDao, WeatherNetworkDataSource weatherNetworkDataSource,
    ...
    public synchronized static SunshineRepository getInstance(WeatherDao weatherDao,
            WeatherNetworkDataSource weatherNetworkDataSource, AppExecutors executors) {
    ...
    private boolean isFetchNeeded() {
        return mWeatherDao.countAllFullWeather() < 14;
    }
    ...
    public LiveData<List<WeatherSummaryEntry>> getWeathersForecasts(Date date) {
        initializeData();
        return mWeatherDao.getWeathersAfterDate(date);
    }
}